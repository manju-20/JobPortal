  ...
  <body >
    ...
    <section>
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <div class="jumbotron text-center" style="background-image: url('searc.jpg');background-repeat: no-repeat;background-size: cover;border:2px solid black;opacity: 0.5">
              <!--<span style="color: white;background-color: black;border-radius:20px;font-size: 60px">Search Job</span> -->
      ...
      <div class="row">
        ...
        <div class="row" style="margin-top: 5%;">
          <div class="table-responsive">
            ...
            <table id="myTable" class="table" style="border: 3px solid black;width: 1000px;">
              <thead style="border: 1.5px solid black;">
                <th style="border: 1.5px solid black;background-color: #9cd6d6;width:100px;text-align: center;">Job Name</th>
                <th style="border: 1.5px solid black;background-color: #9cd6d6;width:130px;text-align: center;">Job Description</th>
                <th style="border: 1.5px solid black;background-color: #9cd6d6;width:130px;text-align: center;">Minimum Salary</th>
                <th style="border: 1.5px solid black;background-color: #9cd6d6;width:130px;text-align: center;">Maximum Salary</th>
                <th style="border: 1.5px solid black;background-color: #9cd6d6;width:80px;text-align: center;">Experience</th>
                <th style="border: 1.5px solid black;background-color: #9cd6d6;width:100px;text-align: center;">Qualification</th>
                <th style="border: 1.5px solid black;background-color: #9cd6d6;width:100px;text-align: center;">Action</th>
              </thead>
              <tbody>
