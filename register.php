      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            ?>
              <li><a href="company.php" style="font-family: Gill Sans, Helvetica, sans-serif; font-size:1.3em; padding-right:25px; padding-top:23px; font-weight:500">Company</a></li>
              <li><a href="register.php" style="font-family: Gill Sans, Helvetica, sans-serif; font-size:1.3em; padding-right:25px; padding-top:23px; font-weight:500">Register</a></li>
              <li><a href="login.php" style="font-family: Gill Sans, Helvetica, sans-serif; font-size:1.2em; padding-right:25px; padding-top:23px; font-weight:500">Login</a></li>
            <?php } ?>
          </ul>
        </div><!-- /.navbar-collapse -->
      </div><!-- /.container-fluid -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 col-md-offset-4 well">
          <h2 class="text-center" style="text-transform: uppercase; font-weight:600;">Register</h2>
