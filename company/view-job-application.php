...
<html lang="en">
  ...
  <body style="background-image: url(../Images/bg2.jpg); background-size:cover;">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">     
            <ul class="nav navbar-nav navbar-right">
              <li><a href="http://localhost/MN-Creations/JobPortal/company/dashboard.php" style="font-family: Gill Sans, Helvetica, sans-serif; font-size:1.3em; padding-right:25px; padding-top:26px; font-weight:500">Logout</a></li>
            </ul>
          </div><!-- /.navbar-collapse -->
        </div><!-- /.container-fluid -->
      </nav>
    ...
    <div class="container">
      <div class="row">
        <h2 class="text-center" style="text-transform: uppercase; font-weight:600; padding-bottom:15px; border-bottom:2px solid #e5e5e5">User Application</h2>
