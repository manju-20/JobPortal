...
<html lang="en">
  ...
  <style type="text/css">
    body{
      background-image: url('createjob.png');
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">     
            <ul class="nav navbar-nav navbar-right">
              <li><a href="dashboard.php" style="font-family: Gill Sans, Helvetica, sans-serif; font-size:1.3em; padding-right:25px; padding-top:26px; font-weight:500">Dashboard</a></li>
              <li><a href="logout.php" style="font-family: Gill Sans, Helvetica, sans-serif; font-size:1.3em; padding-right:25px; padding-top:26px; font-weight:500">Logout</a></li>
            </ul>
          </div><!-- /.navbar-collapse -->
        </div><!-- /.container-fluid -->
      </nav>
    ...
    <section>
      <div class="container">
        <div class="row">
          ...
          <h2 class="text-center" style="text-transform:uppercase; font-weight:600; padding-bottom:15px;">Create Job Post</h2>
