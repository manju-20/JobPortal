        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">     
            <ul class="nav navbar-nav navbar-right">
              <li><a href="../index.php" style="font-family: Gill Sans, Helvetica, sans-serif; font-size:1.3em; padding-right:28px; padding-top:26px; font-weight:500">Logout</a></li>
            </ul>
          </div><!-- /.navbar-collapse -->
        </div><!-- /.container-fluid -->
      </nav>
    ...
    <br><br>
      <div class="row" >
        ...
        <div style="padding-left: 6px;" >
          <a href="create-job-post.php" class="btn btn-success btn-block btn-lg" style="font-size: 210%;">Create Job Post</a>
        </div>
      <br><br><br><br><br>
        <div style="padding-left: 6px;">
          <a href="view-job-post.php" class="btn btn-success btn-block btn-lg" style="font-size: 210%;">View Job Post</a>
        </div>
        ...
        <?php
          ...
          if($result->num_rows > 0) {
            ?>
           <div style="padding-left: 6px;">
             <a href="view-job-application.php" class="btn btn-success btn-block btn-lg" style="font-size: 210%;  margin-top:20px;">View Application <span class="badge"><?php echo $result->num_rows; ?></a>
           </div> 
            <?php
          }
        ?>
