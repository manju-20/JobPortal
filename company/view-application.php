    ...
    <header>
      <nav class="navbar navbar-default">
        <div class="container-fluid">
          ...
          <a class="navbar-brand" href="../index.php" style="font-size:2em; font-family:ui-sans-serif; padding-top:32px;"> <span class="head" style="color:red; font-family: Georgia, serif; text-decoration:line-through; font-size:1.2em">JOB</span> PORTAL <span style="color:#80b918; font-size:20px; font-weight:bold; padding-left:10px; font-family:ui-sans-serif">MN CREATIONS</span></a>
          </div>

          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">     
            <ul class="nav navbar-nav navbar-right">
              <li><a href="http://localhost/MN-Creations/JobPortal/index.php" style="font-family: Gill Sans, Helvetica, sans-serif; font-size:1.3em; padding-right:25px; padding-top:26px; font-weight:500">Logout</a></li>
            </ul>
          </div><!-- /.navbar-collapse -->
        </div><!-- /.container-fluid -->
      </nav>
    ...
    <div class="container">
      <div class="row">
        <div class="panel panel-info">
          <div class="panel-heading" style="font-size:2em; text-align:center;">User Application</div>
          <div class="panel-body">
            <?php
              ...
              ?>
                ...
                ?>
                <a href="success.php" id="open-popup-btn" style="padding:9px 11px; border:1px solid; margin:0 7px; background-color:#118ab2; color:#edf2f4; border-radius:6px;">Call For Interview</a>
