...
<style type="text/css">
  body {
    background-image: url('complog.jpg');
    ...
    <nav class="navbar navbar-default">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php" style="font-size:1.8em; 
          font-family:ui-sans-serif; padding-top:26px;"> <span class="head" style="color:red;
          font-family: Georgia, serif; text-decoration:line-through; font-size:1.2em">JOB</span>
            PORTAL </a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            ?>
              ...
              <li><a href="company-register.php" style="font-family: Gill Sans, Helvetica, sans-serif; font-size:1.3em; 
              padding-right:25px; padding-top:23px; font-weight:500">Register</a></li>
              <li><a href="login.php" style="font-family: Gill Sans, Helvetica, sans-serif; font-size:1.3em; 
              padding-right:25px; padding-top:23px; font-weight:500">User Login</a></li>
            <?php } ?>
          </ul>
        </div><!-- /.navbar-collapse -->
      </div><!-- /.container-fluid -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 col-md-offset-4 well" style="margin-top:50px;">
          <h2 class="text-center" style=" text-transform:uppercase; font-weight:600; padding-bottom:13px;">Company Login</h2>
